...
<script data-skip-moving="true">
        ...
        })(window,document,'https://cdn.bitrix24.ru/b5716799/crm/site_button/loader_2_q2ua9x.js');
</script>
 ...
 <script id="bx24_form_button" data-skip-moving="true">
        (function(w,d,u,b){w['Bitrix24FormObject']=b;w[b] = w[b] || function(){arguments[0].ref=u;
                ...
                h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);
        })(window,document,'https://b24-nu7s5j.bitrix24.ru/bitrix/js/crm/form_loader.js','b24form');

        b24form({"id":"4","lang":"ru","sec":"5rswsk","type":"button","click":""});
    ...
    <div class="yolo-site">
              ...
              <div class="top-sidebar top-bar-left col-md-4">
                <aside id="text-11" class="widget widget_text">
                  <div class="textwidget">
                    <div>Добро пожаловать на сайт WATRUSHKA</div>
                  </div>
                </aside>
              </div>
              <div class="top-sidebar top-bar-right col-md-8">
                <aside id="text-6" class="widget widget_text">
                  <div class="textwidget"><i class="fa fa-home"></i>ИАТУ<i style="margin-left: 15px" class="fa fa-phone"></i> + 46 234-623-213<i style="margin-left: 15px" class="fa fa-clock-o"></i> ПН - ПТ: 9.00 - 8.00</div>
                </aside>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="header-customize header-customize-right">
                  <div class="custom-text-wrapper header-customize-item">Добро пожаловать на сайт WATRUSHK</div>
                  <div class="custom-text-wrapper header-customize-item"><i class="fa fa-truck"></i>Бесплатная доставка при заказе на 10000р. и более</div>
                  <div class="shopping-cart-wrapper header-customize-item with-price">
                    <div class="widget_shopping_cart_content">
                      <div class="widget_shopping_cart_icon"><i class="wicon fa fa-shopping-bag"></i><span class="total">0</span></div>
                      <div class="sub-total-text"><span class="product-begreen-price-amount amount">0.00р.</span></div>
                      <div class="cart_list_wrapper">
                        <div class="scroll-wrapper cart_list product_list_widget scrollbar-inner">
                          <ul class="cart_list product_list_widget scrollbar-inner scroll-content">
                            <li class="empty">
                              <h4>Корзина пуста</h4>
                              <p>Вы еще не добавили товаров в вашу корзину</p>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="main-nav-wrapper">
              <div class="header-left">
                <nav id="primary-menu" class="main-nav">
                  <ul class="nav">
                    ...
                    <li class="mega-menu menu-item"></a>
                    ...
                    <li class="menu-item menu-blog"><a href="#">Статьи</a>
                      <ul class="sub-menu">
                       <li><a href="#">Кухни</a></li>
                        <li><a href="#">Ваныне комнаты</a></li>
                       <li><a href="#">Декор</a></li>
						<li><a href="#">Прочие помещения</a></li>
						<li><a href="#">Растения и сад</a></li>
                  ...
                  <li class="menu-item menu-item-object-page"><li><a href="#">Фото</a>
                      <ul class="sub-menu">
                        <li class="menu_style_dropdown menu-item"><a href="#">Кухня и столовая</a>
                          <ul class="sub-menu">
                            <li class="menu-item menu-item-object-page"><li><a href="#">Кухня</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Домашний бар</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Винный погреб</a></li>
                          </ul>
                        </li>
                        <li class="menu_style_dropdown menu-item"><a href="#">Спальня и гостинная</a>
                          <ul class="sub-menu">
                            <li class="menu-item menu-item-object-page"><li><a href="#">Спальня</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Прихожая</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Коридор</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Балкон и лоджия</a></li>
                          </ul>
                        </li>
                        <li class="menu_style_dropdown menu-item"><a href="project-single.html">Ванная комната</a>
                          <ul class="sub-menu">
                            <li class="menu-item menu-item-object-page"><li><a href="#">Ванная комната</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Душ</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Туалет</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Прачечная</a></li>
                          </ul>
                        </li>
                        <li class="menu_style_dropdown menu-item"><a href="project-top-title.html">Другие коомнаты</a>
                          <ul class="sub-menu">
                            <li class="menu-item menu-item-object-page"><li><a href="#">Сад</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Веранда</a></li>
                            <li class="menu-item menu-item-object-page"><li><a href="#">Бассейн</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Дворик</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Лестницы</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Фасад</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Кабинет</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Тренажерный зал</a></li>
							<li class="menu-item menu-item-object-page"><li><a href="#">Смотреть все</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    <li class="menu-item menu-blog"><a href="#">Поиск эксперта</a>
                      <ul class="sub-menu">
                       <li><a href="#">Архитекторы</a></li>
                      <li><a href="#">Проектирование и строительство</a></li>
                      <li><a href="#">Мебель и аксессуары</a></li>
                      <li><a href="#">Художники и ремесленники</a></li>
						<li><a href="#">Ландшафтный дизайн</a></li>
								<li><a href="#">Строительные материалы</a></li>
										<li><a href="#">Освещение</a></li>
												<li><a href="#">Беседки и веранды</a></li>
                      </ul>
                    </li>
                    <li class="menu-item menu-blog"><a href="#">Покупки</a>
                      <ul class="sub-menu">
                       <li><a href="#">Мебель</a></li>
                        <li><a href="#">Кухня и столовая</a></li>
                        <li><a href="#">Товары для спальни</a></li>
                        <li><a href="#">Товары для ванной</a></li>
						<li><a href="#">Товары для сада</a></li>
						<li><a href="#">Стоительство и ремонт</a></li>
						<li><a href="#">Товары для детей</a></li>
						<li><a href="#">Хранение и ограниация</a></li>
						<li><a href="#">Товары для ванной</a></li>
						<li><a href="#">Смотреть все</a></li>
                      </ul>
                    </li>
                    <li class="menu-item menu-blog"><a href="#">ФОРУМ</a>
                      <ul class="sub-menu">
                        <li><a href="#">выбор дизайна</a></li>
              ...
              <div class="header-right">
                <div class="form-input">
                  <input style="text" placeholder="Поиск"/><a href="#"><i class="fa fa-search"></i></a>
                </div>
              </div>
      ...
      <div id="example-wrapper">
            ...
            <div data-number="1" data-margin="100" data-loop="yes" data-navcontrol="yes" class="begreen-owl-carousel">
              <div class="slider-1">
                ...
                <div class="slider-content slider-1-content">
                  <div class="desc">Новый взгляд на дизайн дома</div>
                  <div class="text">Сделайте дизайн вместе с нами</div>
                <p><a href="registration.html" class="btn btn-4">начать</a></p>
                </div>
                <div class="click-scroll-body">
                  <div class="click-scroll-body-content">
          ...
          <div class="home-3-our-services">
            <div class="container">
              <div class="home-3-our-services-content text-center">
                <h2 class="title-style title-style-1 mb-45"><span class="title-left">Наши</span><span class="title-right">Сервисы</span><span class="desc">
              </div>
              <div class="row">
                <div class="col-md-3 col-sm-6">
                  <div class="style_4 icon-box-shortcode-wrap">
                    <div class="icon-box-container">
                      <div class="icon-wrap">
                        <div class="icon-main bg-1f2a37"><span class="fa fa-leaf color-fff"></span></div>
                      </div>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="style_4 icon-box-shortcode-wrap">
                    <div class="icon-box-container">
                      ...
                      <div class="icon-content">
                        <div class="icon-title">Бесплатная доставка</div>
                        <p class="icon-description">Lorem ipsum dolor sit amet, morbi justo sit lacinia vestibulum.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="style_4 icon-box-shortcode-wrap">
                    <div class="icon-box-container">
                      <div class="icon-wrap">
                        <div class="icon-main bg-1f2a37"><span class="fa fa-user-secret color-fff"></span></div>
                      </div>
                      <div class="icon-content">
                        <div class="icon-title"> 100% ГАРАНТИЯ</div>
                        <p class="icon-description">Lorem ipsum dolor sit amet, morbi justo sit lacinia vestibulum.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="style_4 icon-box-shortcode-wrap">
                    <div class="icon-box-container">
                      <div class="icon-wrap">
                        <div class="icon-main bg-1f2a37"><span class="fa fa-diamond color-fff"></span></div>
                      </div>
                      <div class="icon-content">
                        <div class="icon-title">ВОЗВРАТ СРЕДСТВ ПОСЛЕ ? ДНЕЙ</div>
                        <p class="icon-description">Lorem ipsum dolor sit amet, morbi justo sit lacinia vestibulum.</p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="div-box mb">
          <div class="home-3-new-collections">
            <div class="container">
              <h2 class="title-style title-style-1 text-center"><span class="title-left">Новая</span><span class="title-right">Коллекция</span><span class="desc">
              <div data-js-module="filtering-demo" class="big-demo go-wide">
                <div class="filter-button-group button-group js-radio-button-group container">
                  ...
                  <button data-filter=".featured" class="button">Популярные</button>
                  <button data-filter=".indoor" class="button">Для дома</button>
                  <button data-filter=".new" class="button">Новое</button>
                  <button data-filter=".outdoor" class="button">Для улицы</button>
                  <button data-filter=".pots" class="button">Еще что-то</button>
                  <button data-filter=".seeds" class="button">И еще что-то</button>
                </div>
                  ...
                  <li data-category="outdoor" class="element-item product-item-wrap product-style_1 featured indoor new seeds">
                    <div class="product-item-inner">
                      <div class="product-thumb">
                        ...
                        <div class="product-thumb-primary"><img src="images/demo/product-17.jpg" alt="product1" width="375" height="450" class="attachment-shop_catalog size-shop_catalog wp-post-image"/></div><a href="#" class="product-link">
        ...
        <div class="div-box mb">
          <div class="home-3-recent-news">
            <div class="container">
              <h2 class="title-style title-style-1 mb-45 text-center"><span class="title-left">Новые</span><span class="title-right">Статьи</span><span class="desc"></span></h2>
              <div class="blog-wrap">
                <div class="blog-inner blog-style-grid blog-paging-all blog-col-3">
                    ...
                    <div class="post-item">
                      <div class="entry-wrap">
                        <div class="entry-thumbnail-wrap">
                          <div class="entry-thumbnail"><a href="#" class="entry-thumbnail_overlay"><img src="images/demo/1blog3-300x203.jpg" alt="Choose the plants and pots" width="420" height="280" class="img-responsive"/></a><a href="#" class="prettyPhoto"><i class="fa fa-arrows-alt"></i></a></div>
                        </div>
                        <div class="entry-content-wrap">
                          <div class="entry-detail">
                            <h3 class="entry-title"><a href="#">Choose the plants and pots</a></h3>
                            ...
                            </div><a href="#" class="btn-readmore"><span class="span-text">Читать</span></a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <article class="post">
                    <div class="post-item">
                      <div class="entry-wrap">
                        <div class="entry-thumbnail-wrap">
                          <div class="entry-thumbnail"><a href="#" class="entry-thumbnail_overlay"><img src="images/demo/blog4-300x203.jpg" alt="Choose the plants and pots" width="420" height="280" class="img-responsive"/></a><a href="#" class="prettyPhoto"><i class="fa fa-arrows-alt"></i></a></div>
                        </div>
                        <div class="entry-content-wrap">
                          <div class="entry-detail">
                            <h3 class="entry-title"><a href="#">Choose the plants and pots</a></h3>
                  ...
                  <article class="post">
                    <div class="post-item">
                      <div class="entry-wrap">
                        <div class="entry-thumbnail-wrap">
                          <div class="entry-thumbnail"><a href="#" class="entry-thumbnail_overlay"><img src="images/demo/blog5-300x203.jpg" alt="Choose the plants and pots" width="420" height="280" class="img-responsive"/></a><a href="#" class="prettyPhoto"><i class="fa fa-arrows-alt"></i></a></div>
                        </div>
                        <div class="entry-content-wrap">
                          <div class="entry-detail">
                            <h3 class="entry-title"><a href="#">Choose the plants and pots</a></h3>
